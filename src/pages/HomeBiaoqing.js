...
export default class Home extends Component {
    ...
    loadData = async(resolve)=>{
        ...
        switch (this.props.data.classid) {
            case '0':
                url =  urlConfig.sectionListDataBiaoqing + '&classid=' + this.props.data.classid;;
                break;
            default:
                url = this.isNotfirstFetch ?  urlConfig.sectionListDataBiaoqing + '&classid=' + this.props.data.classid : urlConfig.sectionListDataBiaoqing + '&classid=' + this.props.data.classid;
        }
...
// />
    ...
    loadMore = async()=>{
        ...
        switch (this.props.data.classid) {
            case '0':
                url =  urlConfig.sectionListDataBiaoqing + '&classid=' + this.props.data.classid + this.dealWithrequestPage();
                break;
            default:
                url = this.isNotfirstFetch ? urlConfig.sectionListDataBiaoqing + '&classid=' + this.props.data.classid +  this.dealWithrequestPage():urlConfig.sectionListDataBiaoqing + '&classid=' + this.props.data.classid+ this.dealWithrequestPage();
