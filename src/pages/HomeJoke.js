...
export default class Home extends Component {
                ...
                if (isInstalled) {
                    if (data.wechat === 1) {
                        ...
                        WeChat.shareToTimeline({
                            title: "【签名分享】" + this._shareItem && this._shareItem.smalltext.replace(/^(\r\n)|(\n)|(\r)/,""),
                            description: this._shareItem && this._shareItem.smalltext.replace(/^(\r\n)|(\n)|(\r)/,""),
                            type: 'news',
                            webpageUrl: urlConfig.DetailUrl + this._shareItem.classid + '/' + this._shareItem.id,
                            thumbImage: urlConfig.thumbImage,
    ...
    loadData = async(resolve)=>{
        ...
        switch (this.props.data.classid) {
            case '0':
                url =  urlConfig.sectionListJoke + '&classid=' + this.props.data.classid;
                break;
            default:
                url = this.isNotfirstFetch ?  urlConfig.sectionListJoke + '&classid=' + this.props.data.classid :  urlConfig.sectionListJoke + '&classid=' + this.props.data.classid;
        }
    ...
    renderTextAndImage = (item,index) => {
        return <View>
            <Text style={{
                ...
                paddingBottom: 15,
                fontWeight: '300'
            }} onPress={() => { this.setClipboardContent(item.smalltext && item.smalltext.replace(/^(\r\n)|(\n)|(\r)/, ""), index, item) }}>
    ...
    loadMore = async()=>{
        ...
        switch (this.props.data.classid) {
            case '0':
                url =  urlConfig.sectionListJoke + '&classid=' + this.props.data.classid + this.dealWithrequestPage();
                break;
            default:
                url = this.isNotfirstFetch ?  urlConfig.sectionListJoke + '&classid=' + this.props.data.classid +  this.dealWithrequestPage():urlConfig.sectionListJoke + '&classid=' + this.props.data.classid+ this.dealWithrequestPage();
